param(
    ...
    [String]$UserName = "", 
    [Parameter(Mandatory = $false)]
    [String]$WorkerName = "KudaraideeV4", 
    [Parameter(Mandatory = $false)]
    [Int]$API_ID = 0, 
    [Parameter(Mandatory = $false)]
    [String]$API_Key = "", 
...
$Variables | Add-Member -Force @{CurrentProduct = "Kudaraidee"}
$Variables | Add-Member -Force @{CurrentVersion = [Version]"4.0"}
...
$LabelGitHub.Text = "Kudaraidee V4 on GitHub"
$LabelGitHub.add_Click( {[system.Diagnostics.Process]::start("https://github.com/Kudaraidee/Kudaraidee/releases")})
...
$CheckBoxAutostart.location = New-Object System.Drawing.Point(432, 237)
...
$ButtonLoadDefaultPoolsAlgos.Add_Click( {
        try {
            $PoolsAlgos = Invoke-WebRequest "http://bitcoingamer.xyz/poolapi/PoolsAlgos.json" -UseBasicParsing -Headers @{"Cache-Control" = "no-cache"} | ConvertFrom-Json; $PoolsAlgos | ConvertTo-json | Out-File ".\Config\PoolsAlgos.json" 
        }
...
$ButtonWriteConfig.location = New-Object System.Drawing.Point(432, 259)
...
$ButtonWriteConfig.Add_Click( {
        ...
        $ConfigPageControls | ? {(($_.gettype()).Name -eq "TextBox") -and ($_.Tag -in @("Interval", "ActiveMinerGainPct"))} | foreach {
            $Config | Add-Member -Force @{$_.Tag = [Int]$_.Text}
        }
        Write-Config -ConfigFile $ConfigFile -Config $Config
        $MainForm.Refresh
...
$CheckBoxBlockMaster = New-Object system.Windows.Forms.CheckBox
$CheckBoxBlockMaster.Tag = @{name = "PoolName"; Value = "blockmaster"}
$CheckBoxBlockMaster.text = "blockmaster"
$CheckBoxBlockMaster.AutoSize = $false
$CheckBoxBlockMaster.width = 100
$CheckBoxBlockMaster.height = 20
$CheckBoxBlockMaster.location = New-Object System.Drawing.Point(5, 147)
$CheckBoxBlockMaster.Font = 'Microsoft Sans Serif,10'
$CheckBoxBlockMaster.Checked =	$Config.PoolName -contains "blockmaster"
$GroupboxPoolsControls += $CheckBoxBlockMaster

$CheckBoxBlockMasterplus = New-Object system.Windows.Forms.CheckBox
$CheckBoxBlockMasterplus.Tag = @{name = "PoolName"; Value = "blockmasterplus"}
$CheckBoxBlockMasterplus.text = "Plus"
$CheckBoxBlockMasterplus.AutoSize = $false
$CheckBoxBlockMasterplus.width = 60
$CheckBoxBlockMasterplus.height = 20
$CheckBoxBlockMasterplus.location = New-Object System.Drawing.Point(110, 147)
$CheckBoxBlockMasterplus.Font = 'Microsoft Sans Serif,10'
$CheckBoxBlockMasterplus.Checked =	$Config.PoolName -contains "blockmasterplus"
$GroupboxPoolsControls += $CheckBoxBlockMasterplus
	
$CheckBoxBlockMaster24hr = New-Object system.Windows.Forms.CheckBox
$CheckBoxBlockMaster24hr.Tag = @{name = "PoolName"; Value = "blockmaster24hr"}
$CheckBoxBlockMaster24hr.text = "24hr"
$CheckBoxBlockMaster24hr.AutoSize = $false
$CheckBoxBlockMaster24hr.width = 60
$CheckBoxBlockMaster24hr.height = 20
$CheckBoxBlockMaster24hr.location = New-Object System.Drawing.Point(175, 147)
$CheckBoxBlockMaster24hr.Font = 'Microsoft Sans Serif,10'
$CheckBoxBlockMaster24hr.Checked =	$Config.PoolName -contains "blockmaster24hr"
$GroupboxPoolsControls += $CheckBoxBlockMaster24hr
...
$CheckBoxPhiPhiPool.location = New-Object System.Drawing.Point(5, 191)
...
$CheckBoxPhiPhiPoolplus.location = New-Object System.Drawing.Point(110, 191)
...
$CheckBoxPhiPhiPool24hr.location = New-Object System.Drawing.Point(175, 191)
