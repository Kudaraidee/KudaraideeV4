...
However, there is no guarantee whatsoever without even the implied warranty of.
The ability to sell or appropriate for specific purposes.
...
param(
    ...
    [String]$UserName = "", 
    [Parameter(Mandatory = $false)]
    [String]$WorkerName = "KudaraideeV4.1", 
    [Parameter(Mandatory = $false)]
    [Int]$API_ID = 0, 
    [Parameter(Mandatory = $false)]
    [String]$API_Key = "", 
...
$NMIcon = New-Object system.drawing.icon (".\NPM.ICO")
...
$LabelGitHub.Text = "Kudaraidee on GitHub"
$LabelGitHub.add_Click( {[system.Diagnostics.Process]::start("https://github.com/Kudaraidee/KudaraideeV4/releases")})
