param(
    ...
    [Parameter(Mandatory=$false)]
    [String]$WorkerName = "KudaraideeV3", 
    [Parameter(Mandatory=$false)]
    [Int]$API_ID = 0, 
    [Parameter(Mandatory=$false)]
    [String]$API_Key = "", 
...
$WalletDonate = "393yKkxYGycTnApd4GC8toWuhRzsUfD5qg"
$UserNameDonate = "393yKkxYGycTnApd4GC8toWuhRzsUfD5qg"
$WorkerNameDonate = "KudaraideeV3"
$WalletBackup = $Wallet
...
while($true)
{
    ...
    Write-host "Loading BTC rate from Coinbase" -foregroundcolor "Yellow"
    ...
    if($AllPools.Count -eq 0){Write-host "No Pools!" -foregroundcolor "Yellow" | Out-Host; sleep 10; continue}
