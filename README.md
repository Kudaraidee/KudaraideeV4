...
Additional features list
   ...
   GUI
      ...
      Since version 4.0 Kudaraidee has a GUI making it easy to configure and run.
	  Relies on config files. No need to edit bat files. Simply run Kudaraidee With ConfigFile.bat (Not the .ps1) 
   ...
   New version notification
      ...
      Kudaraidee will notify new version availability
*****
...
xiaolin1579 = 3Qp3ka4GTp13osN3zDGVXRZnVh6pH1MstJ

*****
instructions:

Run Kudaraidee With ConfigFile.bat (Not the .ps1)
...
4.Close and run Kudaraidee so it loads your changes properly
...
Permissions of this strong copyleft license are conditioned on making available complete source code of licensed works and modifications, which include larger works using a licensed work, under the same license. Copyright and license notices must be preserved. Contributors provide an express grant of patent rights. https://github.com/Kudaraidee/Kudaraidee-v4/blob/master/LICENSE
